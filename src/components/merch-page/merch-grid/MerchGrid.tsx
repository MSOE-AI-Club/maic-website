...
const merchItems: MerchItem[] = [
    {
        ...
        images: [
            getRawFileUrl('images/merch/MAIC-Researcher-Hoodie.png'),
        ],
    ...
    },
    {
        name: "MAIC T-Shirt",
        images: [
            getRawFileUrl('images/merch/MAIC-Tshirt.png'),
        ],
        cost: "10 Points",
    ...
    {
        name: "MAIC Brain",
        images: [getRawFileUrl('images/merch/Brains.jpg')],
        cost: "1 point",
    ...
    {
        name: "MAIC Polo",
        images: [getRawFileUrl('images/merch/MAIC-Polo.png')],
    ...
    {
        name: "MAIC Hoodie",
        images: [getRawFileUrl('images/merch/MAIC-Basic-Hoodie.png')],
        cost: "35 Points",
    ...
    },
    {
        ...
        images: [getRawFileUrl('images/merch/MAIC-QuarterZip.png')],
        cost: "40 Points",
