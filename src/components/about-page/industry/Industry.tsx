  ...
  const industryList = [
    {
      ...
      image: getRawFileUrl('images/about/msoe_logo_transparent.png'),
      link: "https://msoe.edu/",
    },
    {
      name: "Direct Supply",
      ...
      image: getRawFileUrl('images/about/DirectSupply_Logo.png'),
    ...
    },
    {
      ...
      image: getRawFileUrl('images/about/NVIDIA_Logo.jpg'),
